...
data_drop_2023.rename(columns={'Année obtention du diplôme': 'date_diplome',
                             ...
                             'Quel était votre rémunération brute annuelle (HORS PRIMES) ?': 'remuneration_annuelle_brute_hors_prime_premier_emploi',#jusqu'ici point 2eme check
