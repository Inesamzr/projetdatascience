...
donnees_2021 = pd.read_csv('enquete_2021DS-2.csv', sep=';')

donnees_2021.rename(columns={               'Année obtention du diplôme': 'date_diplome', 
                                            'Formation': 'filiere', 
                                            'Sexe' : 'sexe',
                                            ...
                                            "Dans quelle région?13" : "region_premier_emploi",
                                            ...
                                            'Quel était votre rémunération brute annuelle (HORS PRIMES et 13ème mois) ?' : 'remuneration_annuelle_brute_premier_emploi',
                                            'Perceviez vous des primes?' : 'prime_premier_emploi',
                                            'Quel était votre rémunération brut AVEC PRIMES et 13ème mois?' : 'remuneration_prime_premier_emploi',
...
donnees_2021 = donnees_2021.drop(columns=[colonne for colonne in colonnes_a_supprimer if colonne in donnees_2021.columns])

donnees_2021.to_csv('enquete_2021DS-2_nettoyer.csv', index=False) 